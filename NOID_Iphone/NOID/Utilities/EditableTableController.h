...
@required
- (void)moveTableView:(EditableTableController *)tableView willMoveRowAtIndexPath:(NSIndexPath *)indexPath;
- (BOOL)moveTableView:(EditableTableController *)tableView canMoveRowAtIndexPath:(NSIndexPath *)indexPath;
