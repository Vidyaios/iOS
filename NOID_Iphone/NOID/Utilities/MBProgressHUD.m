...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
       // self.color =nil;  //[UIColor grayColor];
        //self.color = [UIColor colorWithRed:211/255.0 green:211/255.0 blue:211/255.0 alpha:0.7];
        self.color = [UIColor blackColor]; //lblRGBA(88,88,88,0.6);
		self.labelFont = [UIFont boldSystemFontOfSize:kLabelFontSize];
        self.labelColor = [UIColor whiteColor]; //lblRGBA(0,151, 205, 1);
...
- (void)updateIndicators {
    ...
    if (mode == MBProgressHUDModeIndeterminate &&  !isActivityIndicator) {		//[indicator removeFromSuperview];
        self.indicator=MB_AUTORELEASE([[UIImageView alloc]initWithImage:[UIImage imageNamed:@"spinnerlogo"]]);
        [self.class rotateLayerInfinite:indicator.layer];
